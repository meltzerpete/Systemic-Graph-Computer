...
public class TripletSelectionTest {
    ...
    public void shouldFindTriplets() throws Throwable {
        try(Driver driver = GraphDatabase.driver( neo4j.boltURI() , Config.build()
            ...
            StatementResult result = session.run("CALL originalGraphEngine.selectTriplet()");
//            StatementResult resul2 = session.run("CALL originalGraphEngine.selectTriplet()");
//            StatementResult resul3 = session.run("CALL originalGraphEngine.selectTriplet()");
        }
    }
}