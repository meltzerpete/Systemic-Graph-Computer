...
public class Compute {
    ...
    @Procedure(value = "originalGraphEngine.compute", mode = Mode.SCHEMA)
    @Description("")
...
//        db.execute("CALL originalGraphEngine.findMatchesWithProperties");
        MatchingWithProperties.findMatchesWithProperties(db, log);

        // index READY systems
//        db.execute("CALL originalGraphEngine.indexReady");
